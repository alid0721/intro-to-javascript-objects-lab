...
*/
const pokemonSelected= pokemon.find(pokemon => pokemon.starter)
game.party.push(pokemonSelected)
/*
Exercise 5
...
*/
game.party.push(pokemon.find(pokemon => pokemon.name==="Charizard"))
game.party.push(pokemon.find(pokemon=>pokemon.name==="Mewtwo"))
game.party.push(pokemon.find(pokemon=>pokemon.name==="Growlithe"))
...
*/
function evolveStarter(game,poke){
  game.party.forEach((pokemon,index)=>{
    if (pokemon.starter){
      if(pokemon.number===1){
        game.party.splice(index,1,poke[1])
      } else if(pokemon.number===4){
        game.party.splice(index,1,poke[4])
      } else if(pokemon.number===7){
        game.party.splice(index,1,poke[6])
      } else if(pokemon.number===25){
        game.party.splice(index,1,poke[25])
      }
    }
  })
}
evolveStarter(game,pokemon)
/*
Exercise 8
...
game.catchPokemon(pokemon.find(pokemon=> pokemon.name==="Venonat"))
/*
Exercise 11
...
game.catchPokemon(pokemon.find(pokemon=> pokemon.name==="Pidgey"))
...
game.gyms.forEach(pokeGym=>{
  if (pokeGym.completed){
